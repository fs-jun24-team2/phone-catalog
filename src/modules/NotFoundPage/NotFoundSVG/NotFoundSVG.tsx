    ...
    <div className={styles.cls}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
        ...
        <g id="Layer_12 yellow-back-fig" data-name="Layer 12">
          ...
          <g id="round-conf">
            <path
              className={`${styles['cls__1']} ${styles.circle} ${styles.c1}`}
            ...
            />
            <path
              className={`${styles['cls__1']} ${styles.circle} ${styles.c2}`}
            ...
            />
            <path
              className={`${styles['cls__1']} ${styles.circle} ${styles.c3}`}
            ...
            />
            <path
              className={`${styles['cls__1']} ${styles.circle} ${styles.c4}`}
            ...
            />
            <path
              className={`${styles['cls__1']} ${styles.circle} ${styles.c5}`}
            ...
            />
            <path
              className={`${styles['cls__1']} ${styles.circle} ${styles.c6}`}
        ...
        <g className={styles['umbrella']} data-name="Layer 3">
          <g>
            <circle
        ...
        <g className={styles['pillow']} data-name="Layer 4">
          <path
            className={styles['cls__1']}
        ...
        <g className={styles['cup']} data-name="Layer 7">
          <polygon
            className={styles['cls__1']}
        ...
        <g id="clock" data-name="Layer 8">
          ...
          />
          <rect
            className={`${styles['cls__3']} ${styles['clock-hand-1']}`}
            x="845"
            y="189.5"
            width="6.04"
            height="58"
          ...
          />
          <rect
            className={`${styles['cls__3']} ${styles['clock-hand-2']}`}
            x="845"
            y="209.5"
            width="6.04"
            height="38"
        ...
        <g className={styles['rucksack']} data-name="Layer 6">
          <g className={styles['stripe']}>
            <path
              className={styles['cls__12']}
        ...
        <g className={styles['bike']} data-name="Layer 5">
          <path
            className={`${styles['cls__8']} ${styles['wheel']}`}
